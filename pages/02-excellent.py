...
if selected_mbti == "":
    ...
    * 통계 정보를 바탕으로 당신에게 **맞춤형 멘트**를 전달합니다.
    ...
    style_metric_cards(background_color="#FFFFFF", border_left_color=f"#{info['color']}", border_size_px=2, border_color="#000000", border_radius_px=10, border_hover_color="#0072B5", box_shadow=True)
